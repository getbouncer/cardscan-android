...
public class CreditCardBase implements Parcelable {
    ...
    public CreditCardBase(@NonNull String number, @Nullable String expiryMonth,
    ...
    private CreditCardBase(Parcel in) {
    ...
    public static final Creator<CreditCardBase> CREATOR = new Creator<CreditCardBase>() {
        @Override
        public CreditCardBase createFromParcel(Parcel in) {
            return new CreditCardBase(in);
        }

        @Override
        public CreditCardBase[] newArray(int size) {
            return new CreditCardBase[size];
        }
    };
